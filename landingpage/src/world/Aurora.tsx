...
void main() {
  ...
  // deep zinc base (the app's #09090b)
  vec3 col = vec3(0.032, 0.032, 0.042);

  // warm golden light washes — the app's gold accent, kept dim so the
  // page itself stays the star: calmer, darker, peaceful
  col += vec3(0.83, 0.69, 0.33) * smoothstep(0.52, 0.98, n1) * 0.15;
  col += vec3(0.97, 0.9, 0.72) * smoothstep(0.5, 0.94, n2) * 0.10;
  col += vec3(0.72, 0.62, 0.44) * smoothstep(0.52, 0.98, n3) * 0.06;
  col += vec3(1.0, 0.96, 0.82) * smoothstep(0.58, 0.98, n4) * 0.05;
