  ...
  return (
    <section className="relative overflow-hidden py-24 text-center sm:py-48">
      ...
      <div className="relative z-10 mx-auto flex max-w-3xl flex-col items-center px-6">
        <Reveal>
          <span className="u-label text-[11px] text-white/55">( orbit_is_open )</span>
        </Reveal>
        <Reveal delay={0.08}>
        ...
        <Reveal delay={0.18}>
          <p className="mt-6 max-w-sm text-sm leading-relaxed text-mist">
            Orbit is open — create your account in under a minute. Your
            inner circle is already inside, waiting for you.
          </p>
        </Reveal>
      </div>
      ...
      <div className="relative z-10 mx-auto flex max-w-3xl flex-col items-center px-6">
        <Reveal delay={0.26}>
          <div className="flex flex-col items-center justify-center gap-4 sm:flex-row">
            <Magnetic>
              <a href="#auth-section" className="btn btn-primary">
                Create account
