...
export function SplitWords({
  ...
  useEffect(() => {
    ...
    // Failsafe for scroll-reveals: if ScrollTrigger positions go stale (late
    // image loads shift the layout) the words would stay at opacity 0 inside
    // their masks forever. Watch at the same threshold — whichever fires
    // first reveals them, so headings are NEVER stuck invisible.
    let revealed = false;
